...
namespace Ikas.Notification.DesktopNotificationManager
{
    public class DesktopNotificationManagerCompat
    {
            ...
            where T : NotificationActivator
        {
            ...
            string shortcutPath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + $"\\Microsoft\\Windows\\Start Menu\\Programs\\{_aumid}.lnk";
            if (!File.Exists(shortcutPath))
            {
                //RegisterComServer<T>(exePath);
                InstallShortcut<T>(shortcutPath, exePath);
            }
