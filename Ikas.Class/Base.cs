...
namespace Ikas.Class
{
    public class Base
    {
        public enum ErrorType
        {
            ...
            salmon_run_schedule_is_not_ready = 3000,
            salmon_run_schedule_cannot_be_resolved,
            salmon_run_stage_cannot_be_resolved = 3100,
            salmon_run_stage_weapon_cannot_be_resolved = 3110,
            salmon_run_battle_is_not_ready = 4000,
            salmon_run_battles_cannot_be_resolved,
            salmon_run_battle_cannot_be_resolved,
            wave_cannot_be_resolved = 4100,
            salmon_run_player_cannot_be_resolved = 4200,
            salmon_run_weapon_cannot_be_resolved = 4300,
            salmon_run_special_weapon_cannot_be_resolved = 4310,
